...
def create_spark_session():    #Create Spark session with required configs
...
def create_initial_dataframe(spark_session):       #Reads the streaming data and creates the initial dataframe accordingly
...
def create_final_dataframe(df, spark_session):      #Modifies the initial dataframe, and creates the final dataframe.
...
def start_streaming(df):         #Starts the streaming to table spark_streaming.random_names in cassandra
